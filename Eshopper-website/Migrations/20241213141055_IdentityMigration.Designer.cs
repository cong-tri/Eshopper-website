...
namespace Eshopper_website.Migrations
{
    ...
    [Migration("20241213141055_IdentityMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eshopper_website.Models.Coupon", b =>
                {
                    b.Property<int>("COUP_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("COUP_ID"));

                    b.Property<DateTime>("COUP_DateExpire")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("COUP_DateStart")
                        .HasColumnType("datetime2");

                    b.Property<string>("COUP_Description")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("COUP_Name")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<int>("COUP_Quantity")
                        .HasColumnType("int");

                    b.Property<int>("COUP_Status")
                        .HasColumnType("INT");
            ...
            modelBuilder.Entity("Eshopper_website.Models.Identity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Eshopper_website.Models.Identity.AppUser", null)
                        .WithMany()
